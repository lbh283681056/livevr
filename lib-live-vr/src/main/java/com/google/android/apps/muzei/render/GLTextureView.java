...
public class GLTextureView extends TextureView implements TextureView.SurfaceTextureListener {
     ...
     * 属性 glWrapper the new GLWrapper
     */
     ...
     * 属性 debugFlags the new debug flags
     ...
     *
     * 属性 preserveOnPause preserve the EGL context when paused
     */
     ...
     * </ul>
     *
     * 属性 renderer the renderer to use to perform OpenGL drawing.
     */
     ...
     * 属性 version The EGLContext client version to choose. Use 2 for OpenGL ES 2.0
     */
     ...
     *
     * 属性 renderMode one of the RENDERMODE_X constants
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int width, int height) {
        Log.e("fuck","onSurfaceTextureAvailable");
        if(mGLThread!=null){
     ...
     * Must not be called before a renderer has been set.
     * 属性 r the runnable to be run on the GL rendering thread.
     */
    ...
    public interface GLWrapper {
         ...
         * 属性 gl a GL interface that is to be wrapped.
    ...
    public interface EGLConfigChooser {
         ...
         * 属性 egl the EGL10 for the current display.
         * 属性 display the current display.
