...
public class MDVRLibrary {
    ...
    public static class Builder {
         ...
         *
         * 属性 motionDelay default is {@link android.hardware.SensorManager#SENSOR_DELAY_GAME}
         * @return builder
         */
         ...
         * build it!
         *
         * 属性 glViewId will find the GLSurfaceView by glViewId in the giving {@link #activity}
