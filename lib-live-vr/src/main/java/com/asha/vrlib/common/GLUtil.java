...
public class GLUtil {
     ...
     *
     * 属性 shaderType   The shader type.
     * 属性 shaderSource The shader source code.
     ...
     *
     * 属性 vertexShaderHandle   An OpenGL handle to an already-compiled vertex shader.
     * 属性 fragmentShaderHandle An OpenGL handle to an already-compiled fragment shader.
     * 属性 attributes           Attributes that need to be bound to the program.
